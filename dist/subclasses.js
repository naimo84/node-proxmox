...
exports.openvz = void 0;
var openvz = /** @class */ (function () {
    function openvz(get, post, del, put) {
        this.get = get;
        this.post = post;
        this.del = del;
        this.put = put;
    }
    openvz.prototype.createOpenvzContainer = function (node, data, callback) {
        var url = '/nodes/' + node + '/openvz';
        this.post(url, data, callback);
    };
    openvz.prototype.mountOpenvzPrivate = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/status/mount';
        this.post(url, data, callback);
    };
    openvz.prototype.shutdownOpenvzContainer = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/status/shutdown';
        this.post(url, data, callback);
    };
    openvz.prototype.startOpenvzContainer = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/status/start';
        this.post(url, data, callback);
    };
    openvz.prototype.stopOpenvzContainer = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/status/stop';
        this.post(url, data, callback);
    };
    openvz.prototype.unmountOpenvzContainer = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/status/unmount';
        this.post(url, data, callback);
    };
    openvz.prototype.migrateOpenvzContainer = function (node, vmid, target, callback) {
        var data = { 'target': target };
        var url = '/nodes/' + node + '/openvz/' + vmid + '/migrate';
        this.post(url, data, callback);
    };
    openvz.prototype.getContainerIndex = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid;
        this.get(url, data, callback);
    };
    openvz.prototype.getContainerStatus = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + node + '/status/current';
        this.get(url, data, callback);
    };
    openvz.prototype.getContainerBeans = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/status/ubc';
        this.get(url, data, callback);
    };
    openvz.prototype.getContainerConfig = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/config';
        this.get(url, data, callback);
    };
    openvz.prototype.getContainerInitLog = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/initlog';
        this.get(url, data, callback);
    };
    openvz.prototype.getContainerRRD = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/rrd';
        this.get(url, data, callback);
    };
    openvz.prototype.getContainerRRDData = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid + '/rrddata';
        this.get(url, data, callback);
    };
    openvz.prototype.deleteOpenvzContainer = function (node, vmid, callback) {
        var data = {};
        var url = '/nodes/' + node + '/openvz/' + vmid;
        this.del(url, data, callback);
    };
    openvz.prototype.setOpenvzContainerOptions = function (node, vmid, data, callback) {
        var url = '/nodes/' + node + '/openvz/' + vmid + '/config';
        this.put(url, data, callback);
    };
    return openvz;
}());
exports.openvz = openvz;
//  //vm functions
//  class qemu {
